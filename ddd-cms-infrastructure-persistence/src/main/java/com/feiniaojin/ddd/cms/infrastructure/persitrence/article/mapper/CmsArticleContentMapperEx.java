 ...
 */
@Generated("generator")
public interface CmsArticleContentMapperEx {
     ...
     * @return
     */
    List<CmsArticleContent> pageList(Map<String, Object> paramMap);

    CmsArticleContent findOneByBizId(@Param("articleId") String articleId);
}